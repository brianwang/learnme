                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <div style="width: 110px; height: 110px; line-height: 110px;" class="language-skill3 easyPieChart" data-percent="17"><span>-14264</span>%<canvas width="110" height="110"></canvas></div>
                            ...
                            <div class="col-sm-7">
                                ...
                                <ul class="skill-bar">
                                    <li>
                                        <h5>Web Design</h5>
                                        <div class="meter"><span class="lightBlue" style="width: 40%;">27%</span></div>
                                    </li>
                                    <li>
                                        <h5>Wordpress</h5>
                                        <div class="meter"><span class="green" style="width: 80%;">54%</span></div>
                                    </li>
                                    <li>
                                        <h5>Branding</h5>
                                        <div class="meter"><span class="red" style="width: 100%;">67%</span></div>
                                    </li>
                                    <li>
                                        <h5>SEO Optmization</h5>
                                        <div class="meter"><span class="lightOrange" style="width: 60%;">40%</span></div>
                                    </li>
